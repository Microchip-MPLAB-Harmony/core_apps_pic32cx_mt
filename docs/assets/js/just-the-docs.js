...
{"0": {
    ...
    "doc": "SPI Driver asynchronous - Self loopback multi client",
    "title": "Setting up the hardware",
    "content": "The following table shows the target hardware for the application projects. | Project Name | Board | . | pic32cx_mtsh_db.X | PIC32CXMTSH Development Board | . |   |   | . Setting up PIC32CXMTSH Development Board . | Use jumper wire to Connect “Pin 16 of EXT1 header” to “Pin 17 of EXT1 header” . | SPI0 MOSI signal is mapped to PA08 that is routed to “Pin 16 of EXT1 header” | SPI0 MISO signal is mapped to PA09 that is routed to “Pin 17 of EXT1 header” | . | Connect the Debug USB port on the board to the computer using a micro USB cable | . ",
